...
import { FaFacebookF, FaLinkedinIn, FaTwitter } from "react-icons/fa"; // react-icons install kora thakle
  ...
  return (
    <footer className="bg-black text-white p-6 md:p-10">
      ...
      <div className="bg-[#121212] rounded-[40px] p-10 md:p-16 relative overflow-hidden">
        {/* Background Large Text (Optional Effect) */}
        <div className="absolute inset-0 flex items-center justify-center opacity-[0.03] pointer-events-none select-none">
          <h1 className="text-[12rem] font-black">PROFUNK AUDIO</h1>
        </div>
          ...
          <div className="md:col-span-4">
            <div className="flex flex-col mb-6 leading-none">
              <div className="flex items-center">
                ...
                <div className="mx-1 w-6 h-6 bg-white rounded-full flex items-center justify-center">
              ...
              <span className="text-[11px] font-bold tracking-[0.4em] mt-1">
                AUDIO
              </span>
            </div>
