  ...
  const features = [
    {
      ...
      className: "md:col-span-2 bg-[#FDF5ED] hover:bg-black hover:text-white",
      iconColor: "text-gray-800 hover:text-white",
    },
    {
      title: "YouTube",
      desc: "Bombs, missiles small, large & distant",
      className: "md:col-span-1 bg-[#F8FAFC] hover:bg-black hover:text-white",
      iconColor: "text-gray-800 hover:text-white",
    },
    {
    ...
    },
    {
      ...
      desc: "Bombs, missiles small, large & distant",
      className:
        "md:col-span-2 bg-[#FDF5ED] hover:bg-[#010101] hover:text-white",
      iconColor: "text-gray-800 hover:text-white",
    },
  ];
    ...
    <section className="py-20 px-6 max-w-7xl mx-auto">
      <div className="flex flex-col md:flex-row justify-between items-start mb-12 gap-6">
        ...
        <p className="text-gray-400 text-sm max-w-sm md:text-right">
          Our extensive sound effect catalogue delivers sounds & music for every
          creative field. You'll find the exact sounds and music you need to
          deliver a professional result everytime.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        {features.map((item, index) => (
          ...
          >
            ...
            <p
              className={`text-sm ${index === 5 ? "text-gray-400" : "text-gray-500"}`}
            >
              {item.desc}
            </p>
          </div>
