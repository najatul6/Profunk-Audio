import image1 from "../../assets/MPopuplar/1.png";
import image2 from "../../assets/MPopuplar/2.png";
import image3 from "../../assets/MPopuplar/3.png";
import image4 from "../../assets/MPopuplar/4.png";
import image5 from "../../assets/MPopuplar/5.png";
import image6 from "../../assets/MPopuplar/6.png";
    ...
    <section className="py-20 px-6 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {effects?.map((effect, index) => (
          <div
            key={index}
            className="flex flex-col bg-white border border-gray-100 rounded-3xl overflow-hidden hover:shadow-xl transition-shadow duration-300 group"
          >
